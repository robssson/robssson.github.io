...
def process_league(league):
    ...
    league_output_dir = os.path.join("output", "seasons", season_id, prefix)
...
def main():
    ...
    print(f"🗓️  Aktywny sezon: {active_season['label']} ({active_season['id']})")
    leagues = build_leagues(active_season)
